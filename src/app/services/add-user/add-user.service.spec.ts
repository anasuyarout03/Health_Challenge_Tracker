...
describe('AddUserService', () => {
  ...
  it('should add a new user', () => {
    ...
    expect(localStorage.setItem).toHaveBeenCalledWith('workoutData', jasmine.any(String));
    expect(mockSnackBar.open).toHaveBeenCalledWith('User added successfully!', 'Close', { duration: 2000 });
  });
  ...
  it('should not add a user if name is null', () => {
    ...
    expect(mockSnackBar.open).toHaveBeenCalledWith('All fields are required!', 'Close', { duration: 2000 });
